...
// contract SheltorTest is Context, IERC20, Ownable {
...
//     string private _name = "Sheltor Test";
...
//     address payable public charityWallet = 0xb5bc62c665c13590188477dfD83F33631C1Da0ba;
...
//     constructor (address[] memory _investors, uint[] memory _amounts) public {
...
//         _rOwned[_msgSender()] = _rTotal - subFromTotal;
...
//             _rOwned[investors[i]] += presaleOwedPerPeriod[investors[i]];
//         }
//     }
...
//     function _setTeamWallet(address payable _charityWallet) external onlyOwner() {
